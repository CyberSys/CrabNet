...
Description: Demonstrates how to integrate the Steam lobby and NAT traversal sockets with CrabNet via a plugin
...
4. Must recompile CrabNet with MAXIMUM_MTU_SIZE set to 1200 in the preprocessor settings
