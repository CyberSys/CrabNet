...
6. Add to the startup folder (http://support.microsoft.com/kb/2806079) of that user ( C:\Users\Rakkar\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup ) C:\CrabNet\Samples\AutopatcherServer_SelfScaling\Release\AutopatcherServer_SelfScaling.bat
7. In AutopatcherServer_SelfScaling.bat put
cd C:\CrabNet\Samples\AutopatcherServer_SelfScaling
CALL C:\CrabNet\Samples\AutopatcherServer_SelfScaling\Release\AutopatcherServer_SelfScaling.exe serverToServerPassword 60000 8096 8000 version1.mygamepatcher.com mygamepatcher.com https://identity.api.rackspacecloud.com/v2.0 rackspaceUsername rackspaceAPIAccessKey databasePassword 3 6 0
