...
namespace CrabNet
{
    ...
    public:
        ...
        void CreateServer(CrabNet::RakString name, CrabNet::RakString imageId, CrabNet::RakString flavorId);
        ...
        void GetServerDetails(CrabNet::RakString serverId);
        ...
        void UpdateServerNameOrPassword(CrabNet::RakString serverId, CrabNet::RakString newName, CrabNet::RakString newPassword);

        /// \brief Deletes a server
        /// \sa http://docs.rackspacecloud.com/servers/api/v1.0/cs-devguide-20110112.pdf
        /// \sa RackspaceEventCallback::OnDeleteServerResult()
        /// \param[in] serverId Which server to get details on. You can call ListServers() to get the list of active servers.
        void DeleteServer(CrabNet::RakString serverId);
        ...
        void ListServerAddresses(CrabNet::RakString serverId);
        ...
        void ShareServerAddress(CrabNet::RakString serverId, CrabNet::RakString ipAddress);
        ...
        /// \param[in] serverId Which server to operate on. You can call ListServers() to get the list of active servers.
        /// \param[in] ipAddress Which IP address. You can call ListServerAddresses() to get the list of addresses for the specified server
        void DeleteServerAddress(CrabNet::RakString serverId, CrabNet::RakString ipAddress);
        ...
        void RebootServer(CrabNet::RakString serverId, CrabNet::RakString rebootType);
        ...
        /// \param[in] serverId Which server to operate on. You can call ListServers() to get the list of active servers.
        /// \param[in] imageId Which image (harddrive contents, including OS) to use
        void RebuildServer(CrabNet::RakString serverId, CrabNet::RakString imageId);
        ...
        /// \param[in] serverId Which server to operate on. You can call ListServers() to get the list of active servers.
        /// \param[in] flavorId Which flavor (hardware config) to use, primarily how much memory is available.
        void ResizeServer(CrabNet::RakString serverId, CrabNet::RakString flavorId);
        ...
        /// \sa ResizeServer()
        /// \param[in] serverId Which server to operate on. You can call ListServers() to get the list of active servers.
        void ConfirmResizedServer(CrabNet::RakString serverId);
        ...
        /// \sa ResizeServer()
        /// \param[in] serverId Which server to operate on. You can call ListServers() to get the list of active servers.
        void RevertResizedServer(CrabNet::RakString serverId);
        ...
        void GetFlavorDetails(CrabNet::RakString flavorId);
        ...
        void CreateImage(CrabNet::RakString serverId, CrabNet::RakString imageName);
        ...
        void GetImageDetails(CrabNet::RakString imageId);
        ...
        /// \sa ListImages()
        /// \param[in] imageId Which image
        void DeleteImage(CrabNet::RakString imageId);
        ...
        // I don't know what this does
        void GetSharedIPGroupDetails(CrabNet::RakString groupId);
        // I don't know what this does
        void DeleteSharedIPGroup(CrabNet::RakString groupId);
        ...
        void AddOperation(RackspaceOperationType type, CrabNet::RakString httpCommand, CrabNet::RakString operation, CrabNet::RakString xml);
    protected:
        ...
        //    CrabNet::RakString stringInfo;
            SystemAddress connectionAddress;
            bool isPendingAuthentication;
            CrabNet::RakString incomingStream;
            CrabNet::RakString httpCommand;
            CrabNet::RakString operation;
        ...
        CrabNet::RakString serverManagementURL;
        CrabNet::RakString serverManagementDomain;
        CrabNet::RakString serverManagementPath;
        CrabNet::RakString storageURL;
        CrabNet::RakString storageDomain;
        CrabNet::RakString storagePath;
        CrabNet::RakString cdnManagementURL;
        CrabNet::RakString cdnManagementDomain;
        CrabNet::RakString cdnManagementPath;

        CrabNet::RakString storageToken;
        CrabNet::RakString authToken;
        CrabNet::RakString rackspaceCloudUsername;
        CrabNet::RakString apiAccessKey;

        bool ExecuteOperation(RackspaceOperation &ro);
        void ReadLine(const char *data, const char *stringStart, CrabNet::RakString &output);
