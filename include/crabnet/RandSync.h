...
public:
    ...
    virtual void SerializeConstruction(CrabNet::BitStream *constructionBitstream);
    virtual bool DeserializeConstruction(CrabNet::BitStream *constructionBitstream);
    virtual void Serialize(CrabNet::BitStream *outputBitstream);
    virtual void Deserialize(CrabNet::BitStream *outputBitstream);
