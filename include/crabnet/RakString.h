...
public:
    ...
    static CrabNet::RakString FromWideChar_S(const wchar_t *source);
#endif
    ...
    void SetChar( unsigned index, CrabNet::RakString s );
    ...
    static CrabNet::RakString NonVariadic(const char *str);
    ...
    static CrabNet::RakString FormatForPOST(const char* uri, const char* contentType, const char* body, const char* extraHeaders="");
    static CrabNet::RakString FormatForPUT(const char* uri, const char* contentType, const char* body, const char* extraHeaders="");
    ...
    /// \return Formatted string
    static CrabNet::RakString FormatForGET(const char* uri, const char* extraHeaders="");
...
const CrabNet::RakString RAK_DLL_EXPORT operator+(const CrabNet::RakString &lhs, const CrabNet::RakString &rhs);
