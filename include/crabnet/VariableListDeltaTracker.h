...
public:
    ...
    template <class VarType>
    bool WriteVarToBitstream(const VarType &varData, CrabNet::BitStream *bitStream)
    {
    ...
    template <class VarType>
    bool WriteVarToBitstream(const VarType &varData, CrabNet::BitStream *bitStream, unsigned char *bArray, unsigned short writeOffset)
    {
    ...
    template <class VarType>
    static bool ReadVarFromBitstream(VarType &varData, CrabNet::BitStream *bitStream)
    {
        bool wasWritten;
