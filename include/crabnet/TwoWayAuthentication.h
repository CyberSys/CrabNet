...
public:
    ...
    bool AddPassword(CrabNet::RakString identifier, CrabNet::RakString password);
    ...
    struct NonceAndRemoteSystemRequest
    {
        ...
        CrabNet::AddressOrGUID remoteSystem;
        unsigned short requestId;
        CrabNet::Time whenGenerated;
    };
    /// \internal
...
protected:
    void PushToUser(MessageID messageId, CrabNet::RakString password, CrabNet::AddressOrGUID remoteSystem);
    // Key is identifier, data is password
    DataStructures::Hash<CrabNet::RakString, CrabNet::RakString, 16, CrabNet::RakString::ToInteger > passwords;

    CrabNet::Time whenLastTimeoutCheck;
    ...
    void Hash(char thierNonce[TWO_WAY_AUTHENTICATION_NONCE_LENGTH], CrabNet::RakString password, char out[HASHED_NONCE_AND_PW_LENGTH]);
};
