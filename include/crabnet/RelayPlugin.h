...
protected:
    ...
    DataStructures::Hash<RakString, StrAndGuidAndRoom*, 8096, CrabNet::RakString::ToInteger> strToGuidHash;
    DataStructures::Hash<RakNetGUID, StrAndGuidAndRoom*, 8096, CrabNet::RakNetGUID::ToUint32> guidToStrHash;
