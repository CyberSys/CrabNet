...
namespace CrabNet
{
    ...
    public:
        ...
        void EncodeString(const char *input, size_t maxCharsToWrite, CrabNet::BitStream *output);
        ...
        bool DecodeString(char *output, size_t maxCharsToWrite, CrabNet::BitStream *input);
