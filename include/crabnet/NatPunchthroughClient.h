...
struct RAK_DLL_EXPORT PunchthroughConfiguration
{
    ...
    CrabNet::Time TIME_BETWEEN_PUNCH_ATTEMPTS_INTERNAL;
    CrabNet::Time TIME_BETWEEN_PUNCH_ATTEMPTS_EXTERNAL;
...
protected:
    ...
    void IncrementExternalAttemptCount(CrabNet::Time time, CrabNet::Time delta);
    ...
    CrabNet::Time portStrideCalTimeout;
