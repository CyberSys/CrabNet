...
struct FilterSet
{
    ...
    CrabNet::TimeMS disallowedMessageBanTimeMS;
    CrabNet::TimeMS timeExceedBanTimeMS;
    CrabNet::TimeMS maxMemberTimeMS;
    ...
    DataStructures::OrderedList<CrabNet::RakString,CrabNet::RakString> allowedRPC4;
};
...
{
    FilterSet *filter;
    CrabNet::TimeMS timeEnteredThisSet;
};
...
public:
    ...
    /// \param[in] filterSetID A user defined ID to represent a filter set.  If no filter with this ID exists, one will be created with default settings.
    void SetActionOnDisallowedMessage(bool kickOnDisallowed, bool banOnDisallowed, CrabNet::TimeMS banTimeMS, int filterSetID);
    ...
    /// \param[in] banTimeMS Passed to the milliseconds parameter of RakPeer::AddToBanList.
    /// \param[in] filterSetID A user defined ID to represent a filter set.  If no filter with this ID exists, one will be created with default settings.
    void SetFilterMaxTime(int allowedTimeMS, bool banOnExceed, CrabNet::TimeMS banTimeMS, int filterSetID);
