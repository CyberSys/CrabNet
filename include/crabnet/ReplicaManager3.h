...
public:
    ...
    /// \param[in] worldId Used for multiple worlds. World 0 is created automatically by default. See AddWorld()
    bool PushConnection(CrabNet::Connection_RM3 *newConnection, WorldId worldId=0);
    ...
    /// \param[in] worldId Used for multiple worlds. World 0 is created automatically by default. See AddWorld()
    CrabNet::Connection_RM3 * PopConnection(RakNetGUID guid, WorldId worldId=0);
    ...
    /// \param[in] worldId Used for multiple worlds. World 0 is created automatically by default. See AddWorld()
    void Reference(CrabNet::Replica3 *replica3, WorldId worldId=0);
    ...
    /// \param[in] worldId Used for multiple worlds. World 0 is created automatically by default. See AddWorld()
    void Dereference(CrabNet::Replica3 *replica3, WorldId worldId=0);
    ...
    void SetAutoSerializeInterval(CrabNet::Time intervalMS);
...
protected:
    ...
    void DeallocReplicaNoBroadcastDestruction(CrabNet::Connection_RM3 *connection, CrabNet::Replica3 *replica3);
    CrabNet::Connection_RM3 * PopConnection(unsigned int index, WorldId worldId);
    Replica3* GetReplicaByNetworkID(NetworkID networkId, WorldId worldId);
    unsigned int ReferenceInternal(CrabNet::Replica3 *replica3, WorldId worldId);

    PRO defaultSendParameters;
    CrabNet::Time autoSerializeInterval;
    CrabNet::Time lastAutoSerializeOccurance;
...
struct LastSerializationResultBS
{
    ...
    CrabNet::BitStream bitStream[RM3_NUM_OUTPUT_BITSTREAM_CHANNELS];
...
struct SerializeParameters
{
    ...
    CrabNet::BitStream outputBitstream[RM3_NUM_OUTPUT_BITSTREAM_CHANNELS];

    /// Last bitstream we sent for this replica to this system.
    /// Read, but DO NOT MODIFY
    CrabNet::BitStream* lastSentBitstream[RM3_NUM_OUTPUT_BITSTREAM_CHANNELS];

    /// Set to non-zero to transmit a timestamp with this message.
    /// Defaults to 0
    /// Use RakNet::GetTime() for this
    CrabNet::Time messageTimestamp;
    ...
    CrabNet::Connection_RM3 *destinationConnection;
    ...
    CrabNet::Time curTime;
};

/// \ingroup REPLICA_MANAGER_GROUP3
struct DeserializeParameters
{
    CrabNet::BitStream serializationBitstream[RM3_NUM_OUTPUT_BITSTREAM_CHANNELS];
    bool bitstreamWrittenTo[RM3_NUM_OUTPUT_BITSTREAM_CHANNELS];
    CrabNet::Time timeStamp;
    CrabNet::Connection_RM3 *sourceConnection;
};
...
public:
    ...
    virtual Replica3 *AllocReplica(CrabNet::BitStream *allocationIdBitstream, ReplicaManager3 *replicaManager3)=0;
    ...
    bool HasReplicaConstructed(CrabNet::Replica3 *replica);
    ...
    virtual void SerializeOnDownloadStarted(CrabNet::BitStream *bitStream) {(void) bitStream;}

    /// Receives whatever was written in SerializeOnDownloadStarted()
    /// \param[in] bitStream Written in SerializeOnDownloadStarted()
    virtual void DeserializeOnDownloadStarted(CrabNet::BitStream *bitStream) {(void) bitStream;}
    ...
    virtual void SerializeOnDownloadComplete(CrabNet::BitStream *bitStream) {(void) bitStream;}
    ...
    virtual SendSerializeIfChangedResult SendSerialize(CrabNet::Replica3 *replica, bool indicesToSend[RM3_NUM_OUTPUT_BITSTREAM_CHANNELS], CrabNet::BitStream serializationData[RM3_NUM_OUTPUT_BITSTREAM_CHANNELS], CrabNet::Time timestamp, PRO sendParameters[RM3_NUM_OUTPUT_BITSTREAM_CHANNELS], CrabNet::RakPeerInterface *rakPeer, unsigned char worldId, CrabNet::Time curTime);
    ...
    /// \param[in] worldId Which world, see ReplicaManager3::AddWorld()
    /// \param[in] curTime The current time
    virtual SendSerializeIfChangedResult SendSerializeIfChanged(LastSerializationResult *lsr, SerializeParameters *sp, CrabNet::RakPeerInterface *rakPeer, unsigned char worldId, ReplicaManager3 *replicaManager, CrabNet::Time curTime);
    ...
    virtual void SendConstruction(DataStructures::List<Replica3*> &newObjects, DataStructures::List<Replica3*> &deletedObjects, PRO sendParameters, CrabNet::RakPeerInterface *rakPeer, unsigned char worldId, ReplicaManager3 *replicaManager3);

    /// \internal
    void SendValidation(CrabNet::RakPeerInterface *rakPeer, WorldId worldId);
...
protected:
    ...
    */
    ...
    void SendSerializeHeader(CrabNet::Replica3 *replica, CrabNet::Time timestamp, CrabNet::BitStream *bs, WorldId worldId);
...
public:
    ...
    virtual void WriteAllocationID(CrabNet::Connection_RM3 *destinationConnection, CrabNet::BitStream *allocationIdBitstream) const=0;
    ...
    virtual RM3ConstructionState QueryConstruction(CrabNet::Connection_RM3 *destinationConnection, ReplicaManager3 *replicaManager3)=0;
    ...
    virtual RM3DestructionState QueryDestruction(CrabNet::Connection_RM3 *destinationConnection, ReplicaManager3 *replicaManager3) {(void) destinationConnection; (void) replicaManager3; return RM3DS_DO_NOT_QUERY_DESTRUCTION;}
    ...
    virtual bool QueryRemoteConstruction(CrabNet::Connection_RM3 *sourceConnection)=0;
    ...
    virtual void SerializeConstruction(CrabNet::BitStream *constructionBitstream, CrabNet::Connection_RM3 *destinationConnection)=0;
    ...
    virtual bool DeserializeConstruction(CrabNet::BitStream *constructionBitstream, CrabNet::Connection_RM3 *sourceConnection)=0;
    ...
    virtual void SerializeConstructionExisting(CrabNet::BitStream *constructionBitstream, CrabNet::Connection_RM3 *destinationConnection) {(void) constructionBitstream; (void) destinationConnection;};

    /// Same as DeserializeConstruction(), but for an object that already exists on the remote system.
    /// Used if you return RM3CS_ALREADY_EXISTS_REMOTELY from QueryConstruction
    virtual void DeserializeConstructionExisting(CrabNet::BitStream *constructionBitstream, CrabNet::Connection_RM3 *sourceConnection) {(void) constructionBitstream; (void) sourceConnection;};
    ...
    /// \param[in] destinationConnection System that will receive this network message.
    virtual void SerializeDestruction(CrabNet::BitStream *destructionBitstream, CrabNet::Connection_RM3 *destinationConnection)=0;
    ...
    virtual bool DeserializeDestruction(CrabNet::BitStream *destructionBitstream, CrabNet::Connection_RM3 *sourceConnection)=0;
    ...
    virtual CrabNet::RM3ActionOnPopConnection QueryActionOnPopConnection(CrabNet::Connection_RM3 *droppedConnection) const=0;

    /// Notification called for each of our replicas when a connection is popped
    virtual void OnPoppedConnection(CrabNet::Connection_RM3 *droppedConnection) {(void) droppedConnection;}
    ...
    virtual void DeallocReplica(CrabNet::Connection_RM3 *sourceConnection)=0;
    ...
    virtual CrabNet::RM3QuerySerializationResult QuerySerialization(CrabNet::Connection_RM3 *destinationConnection)=0;
    ...
    virtual RM3SerializationResult Serialize(CrabNet::SerializeParameters *serializeParameters)=0;
    ...
    virtual void OnSerializeTransmission(CrabNet::BitStream *bitStream, CrabNet::Connection_RM3 *destinationConnection, BitSize_t bitsPerChannel[RM3_NUM_OUTPUT_BITSTREAM_CHANNELS], CrabNet::Time curTime) {(void) bitStream; (void) destinationConnection; (void) bitsPerChannel; (void) curTime;}
    ...
    virtual void Deserialize(CrabNet::DeserializeParameters *deserializeParameters)=0;
    ...
    virtual void PostSerializeConstruction(CrabNet::BitStream *constructionBitstream, CrabNet::Connection_RM3 *destinationConnection) {(void) constructionBitstream; (void) destinationConnection;}
    ...
    /// \param[in] sourceConnection System that sent us this network message.
    virtual void PostDeserializeConstruction(CrabNet::BitStream *constructionBitstream, CrabNet::Connection_RM3 *sourceConnection) {(void) constructionBitstream; (void) sourceConnection;}

    /// Same as PostSerializeConstruction(), but for objects that returned RM3CS_ALREADY_EXISTS_REMOTELY from QueryConstruction
    virtual void PostSerializeConstructionExisting(CrabNet::BitStream *constructionBitstream, CrabNet::Connection_RM3 *destinationConnection) {(void) constructionBitstream; (void) destinationConnection;}

    /// Same as PostDeserializeConstruction(), but for objects that returned RM3CS_ALREADY_EXISTS_REMOTELY from QueryConstruction
    virtual void PostDeserializeConstructionExisting(CrabNet::BitStream *constructionBitstream, CrabNet::Connection_RM3 *sourceConnection) {(void) constructionBitstream; (void) sourceConnection;}
    ...
    /// \param[in] sourceConnection System that sent us this network message.
    virtual void PreDestruction(CrabNet::Connection_RM3 *sourceConnection) {(void) sourceConnection;}
    ...
    virtual RM3ConstructionState QueryConstruction_ClientConstruction(CrabNet::Connection_RM3 *destinationConnection, bool isThisTheServer);
    ...
    /// \param[in] isThisTheServer True if this system is the server, false if not.
    virtual bool QueryRemoteConstruction_ClientConstruction(CrabNet::Connection_RM3 *sourceConnection, bool isThisTheServer);

    /// \brief Default call for QueryConstruction().
    /// \details Only the server is allowed to create this object. The network topology is client/server
    /// \param[in] destinationConnection destinationConnection parameter passed to QueryConstruction()
    /// \param[in] isThisTheServer True if this system is the server, false if not.
    virtual RM3ConstructionState QueryConstruction_ServerConstruction(CrabNet::Connection_RM3 *destinationConnection, bool isThisTheServer);
    ...
    /// \param[in] sourceConnection destinationConnection parameter passed to QueryConstruction()
    /// \param[in] isThisTheServer True if this system is the server, false if not.
    virtual bool QueryRemoteConstruction_ServerConstruction(CrabNet::Connection_RM3 *sourceConnection, bool isThisTheServer);
    ...
    virtual RM3ConstructionState QueryConstruction_PeerToPeer(CrabNet::Connection_RM3 *destinationConnection, Replica3P2PMode p2pMode=R3P2PM_SINGLE_OWNER);
    /// \brief Default call for QueryRemoteConstruction().
    /// \details All clients are allowed to create all objects. The object is not relayed when remotely created
    /// \param[in] sourceConnection destinationConnection parameter passed to QueryConstruction()
    virtual bool QueryRemoteConstruction_PeerToPeer(CrabNet::Connection_RM3 *sourceConnection);
    ...
    /// \param[in] destinationConnection destinationConnection parameter passed to QueryConstruction()
    /// \param[in] isThisTheServer True if this system is the server, false if not.
    virtual CrabNet::RM3QuerySerializationResult QuerySerialization_ClientSerializable(CrabNet::Connection_RM3 *destinationConnection, bool isThisTheServer);
    /// \brief Default call for QuerySerialization().
    ...
    /// \param[in] destinationConnection destinationConnection parameter passed to QueryConstruction()
    /// \param[in] isThisTheServer True if this system is the server, false if not.
    virtual CrabNet::RM3QuerySerializationResult QuerySerialization_ServerSerializable(CrabNet::Connection_RM3 *destinationConnection, bool isThisTheServer);
    /// \brief Default call for QuerySerialization().
    ...
    /// \param[in] destinationConnection destinationConnection parameter passed to QueryConstruction()
    /// \param[in] p2pMode If controlled only by this system ever, pass R3P2PM_SINGLE_OWNER. Otherwise pass R3P2PM_MULTI_OWNER_CURRENTLY_AUTHORITATIVE or R3P2PM_MULTI_OWNER_NOT_CURRENTLY_AUTHORITATIVE
    virtual CrabNet::RM3QuerySerializationResult QuerySerialization_PeerToPeer(CrabNet::Connection_RM3 *destinationConnection, Replica3P2PMode p2pMode=R3P2PM_SINGLE_OWNER);

    /// Default: If we are a client, and the connection is lost, delete the server's objects
    virtual RM3ActionOnPopConnection QueryActionOnPopConnection_Client(CrabNet::Connection_RM3 *droppedConnection) const;
    /// Default: If we are a server, and the connection is lost, delete the client's objects and broadcast the destruction
    virtual RM3ActionOnPopConnection QueryActionOnPopConnection_Server(CrabNet::Connection_RM3 *droppedConnection) const;
    /// Default: If we are a peer, and the connection is lost, delete the peer's objects
    virtual RM3ActionOnPopConnection QueryActionOnPopConnection_PeerToPeer(CrabNet::Connection_RM3 *droppedConnection) const;
...
public:
    ...
    virtual bool QueryRemoteConstruction(CrabNet::Connection_RM3 *sourceConnection) {return r3CompositeOwner->QueryRemoteConstruction(sourceConnection);}
    virtual bool QueryRelayDestruction(CrabNet::Connection_RM3 *sourceConnection) const {return r3CompositeOwner->QueryRelayDestruction(sourceConnection);}
    virtual void SerializeConstruction(CrabNet::BitStream *constructionBitstream, CrabNet::Connection_RM3 *destinationConnection) {r3CompositeOwner->SerializeConstruction(constructionBitstream, destinationConnection);}
    virtual bool DeserializeConstruction(CrabNet::BitStream *constructionBitstream, CrabNet::Connection_RM3 *sourceConnection) {return r3CompositeOwner->DeserializeConstruction(constructionBitstream, sourceConnection);}
    virtual void SerializeConstructionExisting(CrabNet::BitStream *constructionBitstream, CrabNet::Connection_RM3 *destinationConnection) {r3CompositeOwner->SerializeConstructionExisting(constructionBitstream, destinationConnection);}
    virtual void DeserializeConstructionExisting(CrabNet::BitStream *constructionBitstream, CrabNet::Connection_RM3 *sourceConnection) {r3CompositeOwner->DeserializeConstructionExisting(constructionBitstream, sourceConnection);}
    virtual void SerializeDestruction(CrabNet::BitStream *destructionBitstream, CrabNet::Connection_RM3 *destinationConnection) {r3CompositeOwner->SerializeDestruction(destructionBitstream, destinationConnection);}
    virtual bool DeserializeDestruction(CrabNet::BitStream *destructionBitstream, CrabNet::Connection_RM3 *sourceConnection) {return r3CompositeOwner->DeserializeDestruction(destructionBitstream, sourceConnection);}
    virtual CrabNet::RM3ActionOnPopConnection QueryActionOnPopConnection(CrabNet::Connection_RM3 *droppedConnection) const {return r3CompositeOwner->QueryActionOnPopConnection(droppedConnection);}
    ...
    virtual void PostSerializeConstruction(CrabNet::BitStream *constructionBitstream, CrabNet::Connection_RM3 *destinationConnection) {r3CompositeOwner->PostSerializeConstruction(constructionBitstream, destinationConnection);}
    virtual void PostDeserializeConstruction(CrabNet::BitStream *constructionBitstream, CrabNet::Connection_RM3 *sourceConnection) {r3CompositeOwner->PostDeserializeConstruction(constructionBitstream, sourceConnection);}
    virtual void PostSerializeConstructionExisting(CrabNet::BitStream *constructionBitstream, CrabNet::Connection_RM3 *destinationConnection) {r3CompositeOwner->PostSerializeConstructionExisting(constructionBitstream, destinationConnection);}
    virtual void PostDeserializeConstructionExisting(CrabNet::BitStream *constructionBitstream, CrabNet::Connection_RM3 *sourceConnection) {r3CompositeOwner->PostDeserializeConstructionExisting(constructionBitstream, sourceConnection);}
    virtual void PreDestruction(CrabNet::Connection_RM3 *sourceConnection) {r3CompositeOwner->PreDestruction(sourceConnection);}
};
