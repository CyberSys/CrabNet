...
public:
    ...
    void SetConnectOnNewRemoteConnection(bool attemptConnection, CrabNet::RakString pw);
    ...
    virtual void WriteVJCUserData(CrabNet::BitStream *bsOut) {(void) bsOut;}
    ...
    /// // Your code here
    static void SkipToVJCUserData(CrabNet::BitStream *bsIn);
    ...
    //virtual void WriteVJSUserData(CrabNet::BitStream *bsOut, RakNetGUID userGuid, BitStream *userContext) {(void) bsOut; (void) userGuid; (void) userContext;}
...
protected:
    ...
    void ReadVerifiedJoinInProgressMember(CrabNet::BitStream *bsIn, VerifiedJoinInProgressMember *vjipm);
    ...
    void WriteVerifiedJoinCapable(CrabNet::BitStream *bsOut, VerifiedJoinInProgress *vjip);
    ...
    // Used to track how long CrabNet has been running. This is so we know who has been running longest
    CrabNet::TimeUS startupTime;
    ...
    CrabNet::RakString connectionPassword;
