...
public:
    ...
    UDPForwarderResult StartForwarding(
        SystemAddress source, SystemAddress destination, CrabNet::TimeMS timeoutOnNoDataMS,
    ...
    struct ForwardEntry
    {
        ...
        CrabNet::TimeMS timeLastDatagramForwarded;
...
protected:
    ...
    void RecvFrom(CrabNet::TimeMS curTime, ForwardEntry *forwardEntry);
