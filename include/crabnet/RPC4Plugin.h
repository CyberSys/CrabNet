...
class NetworkIDManager;
    ...
    public:
        ...
        RPC4GlobalRegistration(const char* uniqueID, void ( *functionPointer ) ( CrabNet::BitStream *userData, Packet *packet ));
        ...
        RPC4GlobalRegistration(const char* uniqueID, void ( *functionPointer ) ( CrabNet::BitStream *userData, Packet *packet ), int callPriority);
        ...
        RPC4GlobalRegistration(const char* uniqueID, void ( *functionPointer ) ( CrabNet::BitStream *userData, CrabNet::BitStream *returnData, Packet *packet ));
    ...
    public:
        ...
        bool RegisterFunction(const char* uniqueID, void ( *functionPointer ) ( CrabNet::BitStream *userData, Packet *packet ));
        ...
        void RegisterSlot(const char *sharedIdentifier, void ( *functionPointer ) ( CrabNet::BitStream *userData, Packet *packet ), int callPriority);

        /// \brief Same as \a RegisterFunction, but is called with CallBlocking() instead of Call() and returns a value to the caller
        bool RegisterBlockingFunction(const char* uniqueID, void ( *functionPointer ) ( CrabNet::BitStream *userData, CrabNet::BitStream *returnData, Packet *packet ));
        ...
        void CallLoopback( const char* uniqueID, CrabNet::BitStream * bitStream );
        ...
        void Call( const char* uniqueID, CrabNet::BitStream * bitStream, PacketPriority priority, PacketReliability reliability, char orderingChannel, const AddressOrGUID systemIdentifier, bool broadcast );
        ...
        bool CallBlocking( const char* uniqueID, CrabNet::BitStream * bitStream, PacketPriority priority, PacketReliability reliability, char orderingChannel, const AddressOrGUID systemIdentifier, CrabNet::BitStream *returnData );
        ...
        {
            MessageID messageId;
            DataStructures::OrderedList<CrabNet::RakString,CrabNet::RakString> functions;
        };
        ...
        struct LocalSlotObject
        {
            ...
            LocalSlotObject(unsigned int _registrationCount,int _callPriority, void ( *_functionPointer ) ( CrabNet::BitStream *userData, Packet *packet ))
            ...
            int callPriority;
            void ( *functionPointer ) ( CrabNet::BitStream *userData, Packet *packet );
        };
        ...
        DataStructures::Hash<CrabNet::RakString, LocalSlot*,256, CrabNet::RakString::ToInteger> localSlots;
    ...
    protected:
        ...
        DataStructures::Hash<CrabNet::RakString, void ( * ) ( CrabNet::BitStream *, CrabNet::BitStream *, Packet * ),64, CrabNet::RakString::ToInteger> registeredBlockingFunctions;
        DataStructures::OrderedList<MessageID,LocalCallback*,RPC4::LocalCallbackComp> localCallbacks;

        CrabNet::BitStream blockingReturnValue;
        ...
        void InvokeSignal(DataStructures::HashIndex functionIndex, CrabNet::BitStream *serializedParameters, Packet *packet);
    };
