...
public:
   ...
   void ProcessTCPPacket(Packet *packet);
    ...
    struct OutgoingCommand
    {
        ...
        CrabNet::RakString remotePath;
        CrabNet::RakString data;
        CrabNet::RakString contentType;
        bool isPost;
    };
...
private:
    ...
    CrabNet::RakString incomingData;
    DataStructures::Queue<CrabNet::RakString> results;
    ...
    CrabNet::RakString outgoing, incoming, path, contentType;
