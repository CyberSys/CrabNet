...
inline CrabNet::BitStream& operator<<(CrabNet::BitStream& out, FileListNodeContext& in)
{
    out.Write(in.op);
...
inline CrabNet::BitStream& operator>>(CrabNet::BitStream& in, FileListNodeContext& out)
{
    in.Read(out.op);
