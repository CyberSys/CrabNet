...
// If you want to change these defines, put them in RakNetDefinesOverrides so your changes are not lost when updating CrabNet
...
// Defining it plays nicer with other systems, and uses less CPU, but gives worse CrabNet performance
